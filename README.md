...
El núcleo del sistema ha sido desarrollado sin depender exclusivamente de funciones nativas de alto nivel, demostrando lógica algorítmica pura:
...
3. **Manejo de Memoria:** Uso de diccionarios (Hash Maps) para gestionar el carrito de compras antes de la persistencia en la base de datos.
...
├── controlador/     # Lógica de negocio y algoritmos (Bubble Sort).
...
Navega a la carpeta del proyecto (importante entrar a la subcarpeta):
code
Bash
